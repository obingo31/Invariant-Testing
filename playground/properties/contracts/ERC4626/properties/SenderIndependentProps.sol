...
contract CryticERC4626SenderIndependent is CryticERC4626PropertyBase {
    ...
    function verify_previewWithdrawIgnoresSender(uint256 tokens) public {
        ...
        assertEq(sharesExpectedBefore, sharesExpectedAfter, "previewWithdraw must not be dependent on msg.sender");
    ...
    function verify_previewRedeemIgnoresSender(uint256 shares) public {
        ...
        assertEq(tokensExpectedBefore, tokensExpectedAfter, "previewRedeem must not be dependent on msg.sender");
