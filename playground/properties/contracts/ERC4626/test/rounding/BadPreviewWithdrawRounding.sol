...
contract BadPreviewWithdrawRounding is ERC4626 {
    ...
    constructor(ERC20 _asset) ERC4626(_asset, "Test Vault", _asset.symbol()) {
        ...
        _totalAssets = 1 ether;
        totalSupply = 0.001 ether;
    }
...
contract TestHarness is CryticERC4626Rounding {
    constructor() {
        ...
        ERC4626 _vault = new BadPreviewWithdrawRounding(ERC20(address(_asset)));
